export default function Footer() {
  return (
    <footer className="flex flex-col w-full gap-4 px-2 py-4 md:px-8 md:py-8 bg-neutral-950 md:gap-8">
      {/* En móvil: suscripción arriba y centrada, en PC: a la derecha */}
      <div className="flex flex-col w-full gap-4 md:flex-row md:items-start md:justify-center md:gap-16">
        {/* Links: debajo en móvil, izquierda en PC, todos centrados en PC */}
        <div className="flex flex-row items-start justify-center order-2 w-full gap-2 overflow-x-auto md:order-1 md:w-auto md:gap-16">
          <nav className="flex flex-col gap-1 md:gap-2 min-w-[100px] items-center md:items-center">
        ...
        <div className="order-1 md:order-2 flex flex-col items-center md:items-end min-w-[180px] max-w-xs w-full md:w-auto md:ml-2">
