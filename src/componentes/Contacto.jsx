      ...
      <div className="flex flex-col md:flex-row w-full max-w-6xl mx-auto border-neutral-800 md:divide-x divide-neutral-800">
            ...
            <form className="flex flex-col w-full max-w-sm gap-6">
              <div className="flex w-full gap-4">
                <input
                  type="text"
                  placeholder="Nombre"
                  className="w-1/2 text-white input input-bordered bg-neutral-900 border-neutral-700"
                  required
                />
                <input
                  type="email"
              ...
              <textarea
                ...
                className="w-full text-white textarea textarea-bordered bg-neutral-900 border-neutral-700"
                rows={5}
                required
              />
        ...
        <div className="flex flex-col justify-center flex-1 px-4 py-8 md:px-8 md:py-16 border-t border-neutral-800 md:border-t-0">
          <div className="flex flex-col items-center justify-center min-h-full">
            ...
            <div className="w-full text-xs text-center text-neutral-500">
