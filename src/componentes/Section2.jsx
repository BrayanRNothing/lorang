...
export default function Section2() {
  return (
    <section className="relative flex flex-col items-center justify-center w-full min-h-screen text-slate-900 bg-gradient-to-b from-white to-blue-50 py-16 px-4">
      <div className="container mx-auto text-center">
        ...
        <p className="max-w-3xl mx-auto text-lg md:text-xl leading-relaxed mb-16 text-slate-600">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col items-center p-6 bg-white rounded-lg border border-slate-200 shadow-lg transform transition-transform hover:scale-105 duration-300">
